...
PKG_NAME:=tollgate-module-crowsnest-go
...
GO_PKG:=https://github.com/OpenTollGate/tollgate-module-crowsnest-go.git
...
define Package/$(PKG_NAME)
	SECTION:=net
	CATEGORY:=Network
	TITLE:=TollGate Crowsnest Module
	DEPENDS:=$(GO_ARCH_DEPENDS)
endef

define Package/$(PKG_NAME)/description
	TollGate Crowsnest Module for OpenWrt
endef
...
define Package/$(PKG_NAME)/install
	...
	$(INSTALL_BIN) $(GO_PKG_BUILD_BIN_DIR)/tollgate-crowsnest $(1)/usr/bin/tollgate-crowsnest
endef
